...
Biblio<-read.csv(paste(args[1],"'_Biblioteca_ - Traffic - Gi1_0_18'.csv", sep="/"),sep = ',', header = TRUE, skip = 9)
...
OUTtotal<-cbind( Nu0[,1:3],Vl1[,3], A12[,3], A1[,3], A2[,3], A3[,3], A4[,3], A421[,3], A6[,3], A7[,3], A8[,3], A9[,3], Almacen[,3], ApoDoc[,3], Biblio[,3], Cajas[,3], CCA[,3], CETED[,3], Gobierno[,3], Idiomas[,3], Libreria[,3], Posgrado1[,3], Posgrado2[,3], Seminarios[,3], UIM[,3] )
INtotal<-cbind(Nu0[,1:2],Vl1[,2], A12[,2], A1[,2], A2[,2], A3[,2], A4[,2], A421[,2], A6[,2], A7[,2], A8[,2], A9[,2], Almacen[,2], ApoDoc[,2], Biblio[,2], Cajas[,2], CCA[,2], CETED[,2], Gobierno[,2], Idiomas[,2], Libreria[,2], Posgrado1[,2], Posgrado2[,2], Seminarios[,2], UIM[,2] )

#Drop Inbound column
OUTtotal$Inbound<-NULL

#Add names for columns
names(OUTtotal)=c("Date Outbound", "Nu0", "Vl1","A12", "A1", "A2", "A3", "A4", "A421", "A6", "A7", "A8", "A9", "Almacen", "ApoDoc", "Biblio", "Cajas", "CCA", "CETED", "Gobierno", "Idiomas", "Libreria", "Posgrado1", "Posgrado2", "Seminarios", "UIM" )
names(OUTtotal)=c("Date Inbound", "Nu0", "Vl1","A12", "A1", "A2", "A3", "A4", "A421", "A6", "A7", "A8", "A9", "Almacen", "ApoDoc", "Biblio", "Cajas", "CCA", "CETED", "Gobierno", "Idiomas", "Libreria", "Posgrado1", "Posgrado2", "Seminarios", "UIM" )
#colnames(INtotal)=c( "Nu0", "Vl1","A12", "A1", "A2", "A3", "A4", "A421", "A6", "A7", "A8", "A9", "Almacen", "ApoDoc", "Biblio", "Cajas", "SUM", "CCA", "CETED", "Gobierno", "Idiomas", "Libreria", "Posgrado1", "Posgrado2", "Seminarios", "UIM" )
#OUTtotal<-setNames(OUTtotal,c("Nu0", "Vl1","A12", "A1", "A2", "A3", "A4", "A421", "A6", "A7", "A8", "A9", "Almacen", "ApoDoc", "Biblio", "Cajas", "SUM", "CCA", "CETED", "Gobierno", "Idiomas", "Libreria", "Posgrado1", "Posgrado2", "Seminarios", "UIM" ))
