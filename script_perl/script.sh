...
#Nu0
firefox "http://192.168.50.13/cacti/graph_xport.php?local_graph_id=33&rra_id=0&graph_start=$inicio&graph_end=$fin"
...
mv 'palomar - Traffic - Gi1_0_18.csv' "'_Biblioteca_ - Traffic - Gi1_0_18'.csv"
...
#Posgrado2
firefox "http://192.168.50.13/cacti/graph_xport.php?local_graph_id=23&rra_id=0&graph_start=$inicio&graph_end=$fin"
